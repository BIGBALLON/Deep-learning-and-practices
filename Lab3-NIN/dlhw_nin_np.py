...
model.add(Conv2D(96, (3, 3),padding='same', kernel_regularizer=keras.regularizers.l2(0.001), kernel_initializer=RandomNormal(stddev = 0.04)))
model.add(Activation('relu'))
...
model.add(Conv2D(192, (3, 3), padding='same', kernel_regularizer=keras.regularizers.l2(0.001), kernel_initializer=RandomNormal(stddev = 0.04)))
model.add(Activation('relu'))
...
model.add(Activation('relu'))
model.add(Conv2D(10, (1, 1), kernel_regularizer=keras.regularizers.l2(0.001), kernel_initializer=RandomNormal(stddev = 0.05) ))
model.add(Activation('relu'))
